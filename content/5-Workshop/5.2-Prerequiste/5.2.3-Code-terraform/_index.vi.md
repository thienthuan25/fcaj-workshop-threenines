...
Trong phần này, chúng ta sẽ làm việc trên môi trường dòng lệnh WSL2 chạy Ubuntu. Trước khi bắt đầu, hãy bảo đảm rằng các công cụ sau đã được cài đặt:
...
Trong terminal WSL2, chuyển đến thư mục chứa các file Terraform, sau đó chạy lệnh dưới đây để đăng nhập và kết nối Terraform CLI với HCP Terraform:
