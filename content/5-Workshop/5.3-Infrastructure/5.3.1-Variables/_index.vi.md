...
Trước tiên, chúng ta tạo file `terraform/variables.tf` để khai báo các biến dùng chung cho toàn bộ dự án. Việc tách biến ra riêng giúp dễ tùy chỉnh mà không phải sửa trực tiếp trong code tài nguyên.
