...
In this section, we will create the `terraform/iam.tf` file to define the **access permissions** through an IAM Role and IAM Policy for a Lambda function called Lambda Collector.
