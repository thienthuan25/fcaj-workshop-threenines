...
Tiếp theo, chúng ta sẽ tạo file `terraform/sns.tf`, file này được sử dụng để khởi tạo dịch vụ thông báo **Amazon Simple Notification Service** (SNS). Nhiệm vụ chính của file này là tạo ra một kênh giao tiếp và kết nối nó với địa chỉ email của bạn.
