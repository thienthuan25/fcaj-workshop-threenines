...
Tiếp theo, chúng ta sẽ tạo file `terraform/outputs.tf`. Đây là phần cuối cùng trong phần xây dựng hạ tầng nền. File này được sử dụng để định nghĩa các giá trị đầu ra sau khi Terraform chạy xong.
